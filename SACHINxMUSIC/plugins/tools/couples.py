...
#BOT FILE NAME
from SACHINxMUSIC import app as app
from SACHINxMUSIC.mongo.couples_db import _get_image, get_couple

POLICE = [
    [
        InlineKeyboardButton(
            text="❖ ∣ 𝛅ᴀɴᴀᴛᴀɴɪ Tᴇᴄի ∣ ❖ ",
            url=f"https://t.me/All_SANATANI_BOT",
        ),
    ],
]
    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "SACHINxMUSIC/assets/upic.png"
         try:
         ...
         img = Image.open("SACHINxMUSIC/assets/cppic.png")
